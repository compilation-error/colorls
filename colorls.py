...
ICONS = {'this':u'\uf07c', 'dir':u'\uf07b', 'file':u'\uf15b', 'link':u'\uf35d', 'none': u'\uf0c8', 
			'.py': u'\uf3e2', '.pyc': u'\uf3e2', '.doc': u'\uf1c2', '.docx': u'\uf1c2', '.docm': u'\uf1c2', '.odt': u'\uf1c2', 
...
if __name__ == "__main__":
	...
	parser.add_argument("-B", "--ignore-backups", action="store_true", default=False, help="do not list implied entires ending with ~")
	parser.add_argument("-d", "--directory", action="store_true", default=False, help="list directories themselves, not their contents")
	...
	parser.add_argument("--report", action="store_true", default=False, help="brief report about number of files and directories")
